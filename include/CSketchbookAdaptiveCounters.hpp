...
class CSketchbookAdaptiveCounters {
    friend class CSketchbookAdaptiveCountersTest;

public:
    CSketchbookAdaptiveCounters(size_t init_col_count, size_t init_row_count,
    ...
    CSketchbookAdaptiveCounters(const CSketchbookAdaptiveCounters&) = delete;
    CSketchbookAdaptiveCounters& operator=(const CSketchbookAdaptiveCounters&) = delete;
