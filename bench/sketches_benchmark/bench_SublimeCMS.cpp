...
inline std::unordered_map<std::string, uint32_t> get_extra_parameters(SublimeCMS *sketch) {
    ...
    res["total_adaptation_time"] = total_adaptation_time_cms;
    res["total_expansion_time"] = total_expansion_time_cms;
    res["total_contraction_time"] = total_contraction_time_cms;
    return res;
}
